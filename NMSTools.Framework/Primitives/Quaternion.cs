...
namespace NMSTools.Framework.Primitives
{
	...
	public struct Quaternion : IEquatable<Quaternion>
	{
		...
		public Quaternion(Vector3 startingDirection, Vector3 endingDirection)
		{
			...
			this.xyz = V3Extensions.Cross(endingDirection, startingDirection);
			this.w = Math.Sqrt(Math.Pow(endingDirection.Length, 2) * Math.Pow(startingDirection.Length, 2)) + V3Extensions.Dot(endingDirection, startingDirection);
			Normalize();
		}
		...
		{
			return new Quaternion(
				right.W * left.Xyz + left.W * right.Xyz + V3Extensions.Cross(left.Xyz, right.Xyz),
				left.W * right.W - V3Extensions.Dot(left.Xyz, right.Xyz));
		}
		...
		public static Quaternion Slerp(Quaternion q1, Quaternion q2, double blend)
		{
			...
			double cosHalfAngle = q1.W * q2.W + V3Extensions.Dot(q1.Xyz, q2.Xyz);
